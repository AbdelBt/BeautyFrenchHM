...
export default function MyAvailabilities() {
  ...
  const fetchDays = async (email) => {
    try {
      const response = await axios.get(
        `https://beautyfrenchhm-55cg.onrender.com/employee/days`,
        {
          params: {
            email: email,
          },
  ...
  const fetchDaysOff = async (email) => {
    try {
      const response = await axios.get(
        `https://beautyfrenchhm-55cg.onrender.com/employee/days-off`,
        {
          params: {
            email: email,
          },
  ...
  const handleChangeAvailableDates = async () => {
    ...
    try {
      await axios.post("https://beautyfrenchhm-55cg.onrender.com/employee", {
  ...
  const handleDeleteDayOff = async (dayOffId) => {
    try {
      await axios.delete(
        `https://beautyfrenchhm-55cg.onrender.com/employee/days-off/${dayOffId}`
      );
      toast({
