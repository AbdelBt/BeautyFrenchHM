...
const Admin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("https://beautyfrenchhm-55cg.onrender.com/user/signup", {
        email,
        password,
      });
      toast({
  ...
  const addService = async () => {
    ...
    try {
      await axios.post("https://beautyfrenchhm-55cg.onrender.com/services", {
        name: newService,
      });
      fetchServices();
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://beautyfrenchhm-55cg.onrender.com/services/${id}`
      );
